...
import SearchResults1 from "./PhotoGallery/SearchResults";
function App() {
  return (
    <>
      <NoteState>
        <Router>
          ...
          <Routes>
            ...
            <Route exact path="/contractorsclients" element={<ContractorsClients />}
            />
            ...
            <Route exact path="/educationtraining"element={<EducationTraining />}
            />
            ...
            <Route exact path="/eventorganizers" element={<EventOrganizers />}
            />
            <Route exact path="/eventorganizerservices"element={<EventsOrganizersServices />}
            />
